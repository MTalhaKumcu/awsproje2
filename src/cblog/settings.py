...
DATABASES = {
    "default": {
        ...
        "HOST": "aws-capstone-rds.cpcgyiegef2x.us-east-1.rds.amazonaws.com",  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = "awscapstones-webapp2-blog"  # please enter your s3 bucket name
